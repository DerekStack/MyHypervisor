...
#define EPTPNUMOFMAXVARIABLERANGEMTRRS	255
// Architecture defined number of fixed range MTRRs (1 for 64k, 2 for 16k, 8
// for 4k)
#define EPTPNUMOFFIXEDRANGEMTRRS		11 //1 + 2 + 8

#define EPTPMTRRENTRIESSIZE				EPTPNUMOFMAXVARIABLERANGEMTRRS*EPTPNUMOFFIXEDRANGEMTRRS
...
typedef struct _EPTDATA {
	...
	//EPT_PML4** preallocated_entries;  // An array of pre-allocated entries
	//volatile long preallocated_entries_count;  // # of used pre-allocated entries
	
	MTRR_RANGE_DESCRIPTOR memory_ranges[9];
...
//				    Paramter					//
//////////////////////////////////////////////////
MTRRDATA g_eptp_mtrr_entries[EPTPMTRRENTRIESSIZE];
